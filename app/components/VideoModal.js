...
// }) {
//   const [mounted, setMounted] = useState(false);
//   const videoRef = useRef(null); // ✅ JS: remove <HTMLVideoElement>
...
//   const handleBackdropClick = (e) => { // ✅ remove type annotation
//     if (e.target === e.currentTarget) onClose?.();
//   };

//   // Append muted=1 for ScreenPal iframe on iOS
//   const iframeSafeSrc = isIOS && iframeSrc
//     ? iframeSrc.includes("?")
